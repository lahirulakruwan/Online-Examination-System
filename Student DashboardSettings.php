...
<link rel="stylesheet" type="text/css" href="style/Student DashboardSettings.css">
...
<div id="profile">
	...
	<h1 style="float:left; margin-left:120px; line-height:5px;">Balance</h1>
	<h1 style="float:left; margin-left:150px; line-height:3px; ">73$</h1>
	</div>
	</center>
		<!--Payment-->
		<fieldset id="payment" style="border-radius:10px; border:2px solid black; height:250px; width:398px; margin-left:50; margin-top:10px;">
	<legend style="font-size:24px; margin-left:20px;">Payment</legend>
		...
		<button style="width:150; height:50; border:2px solid black; border-radius:10px; font-size:15px;background-color:black;color:white;"><i class="fa fa-money"></i> Deposit</button>
		</center>
	</fieldset>
	</div>
	<!--Close Account-->
...
?>
	...
	<!--Update Password-->
	<div id="changeemail" style=" position:absolute; right:0; top:485px; right:86px; folat:left; height:240px; width:405px; border-radius:10px; border:2px solid black; margin-left:10px; margin-top:5px; padding:0px;">
	...
	<!--Change Password-->
	<div id="changepassword" style=" position:absolute; right:0; top:735px; right:86px; folat:left; height:240px; width:405px; border-radius:10px; border:2px solid black; margin-left:10px; margin-top:5px; padding:0px;">
