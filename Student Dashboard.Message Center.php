...
<link rel="stylesheet" type="text/css" href="style/Student Dashboard.Message Center.css">
...
<input type = "submit" name="send" value ="Send" style=" background-color:;width:120px;height:30px;margin-left:20px; margin-top:40px; margin-right:0px; padding:0px;border-radius:10px">
