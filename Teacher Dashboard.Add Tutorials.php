...
if (isset($_POST["publish"])) {
	  ...
	  $sql = "INSERT INTO addturorials(tcategory,tsubject,ttitle,tinfo) VALUES('$Tcategory','$Tsubject','$Ttitle','$Tinfo')";
...
<link rel="stylesheet" type="text/css" href="style/Teacher Dashboard.Add Tutorials.css">
<title>Add Turorials</title>
</head>
...
<fieldset id="Settings">
	<legend id="legend1"><i class="fa fa-youtube-play"></i> Add Turorials</legend>
<div style="margin-left:15px; margin-top:10px;">

<form action="Teacher Dashboard.Add Tutorials.php" method="post">
<label class ="p">Category:</label>
<select name="tcategory"  class = "box">
<option>A/L</option>
<option>O/L</option>
<option>Bsc</option>
<option>Msc</option>
...
<select name="tsubject" class="box"  style="margin-left:15px;">
...
<label class ="p">Tutorial Title:</label>
<input  type ="text" name ="ttitle" placeholder ="EnterTutorial Title Here"><br/><br/><br/>
<label class ="p">Upload Tutorial:</label>
<input type ="button" value ="Upload" class="button"><br/><br/>

<h3 style="margin-left:10px;">(Please Upload Tutorial As a MP4 File)</h4><br/>
<h3 style="margin-left:10px;">Information About Your Tutorial :</h4>
<textarea name="tinfo" class = "textarea" rows="7" cols="100" style="resize:none;" >
</textarea>
<br/><br/>
