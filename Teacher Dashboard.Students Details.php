...
<link rel="stylesheet" type="text/css" href="style/Teacher Dashboard.Students Details.css">
...
<fieldset id="Settings">
	<legend id="legend1"><i class="fa fa-users"></i> Students Details</legend>
	
<div style="padding-left:25px;">
<?php
require 'php/connect.php';

$sql="SELECT Regid,Uname,Fname,Email FROM reg"; //WHERE SorT='Student'";
...
if (mysqli_num_rows($result) > 0) {
    ...
    while($row = mysqli_fetch_assoc($result)) {
        //echo ": " . $row["Regid"]. " - Name: " . $row["Fname"]. " " . $row["Email"]. "<br>";
		echo "<tr>";
